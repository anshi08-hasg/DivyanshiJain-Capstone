...
This mirrors the researchmate-agent's Perceive, Act, Observe, Human Review
workflow, minus the re-run-on-violation loop (steps 5 and 6 in the agent's
spec), which isn't reimplemented here.
